...
import sheet from '../../assets/img/sheet3.webp';
...
function Bmerchant() {
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2024/04/shutterstock_2007074588-1-1024x684.jpg.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our paper merchant & converting software brochure</h1>
