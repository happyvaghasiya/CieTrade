...
import sheet from '../../assets/img/sheet4.webp';
...
function Brecycling() {
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2024/04/plastics-new-1024x683.png.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our plastic recycling software brochure</h1>
