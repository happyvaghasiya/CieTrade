...
import sheet from '../../assets/img/sheet.webp';

function Bciedispatch() {
    const countryCodes = {
        "India (भारत)": "+91",
        "United States": "+1",
        "United Kingdom": "+44",
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/12/truck-driver-with-app.png.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our cieDispatch brochure</h1>
                        ...
                        <img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/12/mobile-dispatch-download-brochure.png.webp" alt="sheet" />
                    </Col>
