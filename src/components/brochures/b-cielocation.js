...
function Bcielocation() {
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/07/Mask-Group-30-3.png.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our cieLocation brochure</h1>
                        ...
                        <img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/03/download-solution-sheet-cielocation.png.webp" alt="sheet" />
                    </Col>
