...
function Bclickbale() {
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/2022-08-04_10h14_47.png.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our cieclickBale brochure</h1>
                        ...
                        <img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/03/download-solution-sheet-clickbale.png.webp" alt="sheet" />
                    </Col>
