...
import sheet from '../../assets/img/sheet2.webp';

function Binternational() {
    const countryCodes = {
        "India (भारत)": "+91",
        "United States": "+1",
        "United Kingdom": "+44",
    ...
    return (
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2024/04/iStock_000002343884_Full-1024x683.jpg.webp')` }}>
            ...
            <Container>
                <Row className='py-20'>
                    <Col lg={6} md={12} sm={12} className=''>
                        <h1 className='text-4xl font-bold'>Download our international trading software brochure</h1>
