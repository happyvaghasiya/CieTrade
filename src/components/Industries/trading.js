...
import dixie from '../../assets/logo/dixie.webp';
...
function Trading() {
    ...
    const data = {
        ...
        Tool: [
            { img: mobile1, head: "WEB APPLICATIONS", title: "cieLocation", p: "cieTrade’s inventory scanning app helps your warehouse quickly check and edit inventory, confirm inventory availability and minimize time spent with stock and cycle counts." , id: "Cielocation" },
    ...
    const faqs = [
        {
            question: "Can I attach external documents to my orders?",
        ...
        {
            question: "Can you assign buy/sell representatives to accounts and orders?",
            answer: "Yes, cieTrade allows you to assign multiple buy/sell reps at the Account, Order, and Transaction level.",
        },
        {
            question: "What kinds of product attributes does cieTrade support?",
            answer: "cieTrade provides product attributes such as basis weight, caliper, roll/sheet size, core, ADMT, Moisture %, and Air Dry % to describe your inventory products in more detail.",
        },
        {
        ...
        <div>
            ...
            <Container>
                <Row>
                    ...
                    <Col lg={6} md={6} sm={12} className='py-5'>
                        <h1 className='font-bold text-2xl'>Pulp & Paper Converting</h1>
                        <ul className='py-3 px-4'>
                            ...
                            <li className='list-disc text-gray-500 text-lg'>Tracks waste, labor, overhead, running time and more.</li>
                            ...
                            <li className='list-disc text-gray-500 text-lg'>Uses landed cost valuation that includes processing, freight, and storage, and costs for more accurate reporting of cost of goods and gross profit.</li>
                        </ul>
                    </Col>
                    <Col lg={6} md={6} sm={12} className='py-5'>
                        <h1 className='font-bold text-2xl'>Inventory Control</h1>
                        <ul className='py-3 px-4'>
                            <li className='list-disc text-gray-500 text-lg'>Tracks user-definable pulp and paper attributes including basis weight, caliper, roll/sheet size, core, ADMT, moisture %, air dry % and more.</li>
