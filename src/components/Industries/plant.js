...
import gfl from '../../assets/logo/gfl.webp';
...
function Plant() {
    ...
    const faqs = [
        {
            question: "Does cieTrade's recycling software support scale integration?",
        ...
        {
            question: "What types of inventory tracking does cieTrade's recycling software support?",
            ...
            <Container>
                <Row>
                    ...
                    <Col lg={6} md={6} sm={12} className='py-5'>
                        ...
                        <ul className='py-3 px-4'>
                            <li className='list-disc text-gray-500 text-lg'>Built-in workflow features help organize open tickets, ungraded and unpriced loads, in-process shipments, approvals, logistics notifications, mill releases and more.</li>
                    ...
                    <Col lg={6} md={6} sm={12} className='py-5'>
                        ...
                        <ul className='py-3 px-4'>
                            ...
                            <li className='list-disc text-gray-500 text-lg'>Built-in workflows manage and coordinate ocean booking requests, provide alerts and automate related tasks.</li>
